...
namespace Zomgame
{
    public class ZSpriteBatch : Microsoft.Xna.Framework.Graphics.SpriteBatch
    {
        ...
        public void DrawLines(IList<Vector2> vertices, int thickness , Color color)
        {
        ...
        public void DrawOutline(int x, int y, int width, int height, int thickness, Color color)
        {
        ...
        public void DrawRectangle(int x, int y, int width, int height, Color color, Color borderColor)
        {
            this.DrawRectangle(x, y, width, height, color, 1, borderColor);
        }

        public void DrawRectangle(int x, int y, int width, int height, Color color, int borderThickness, Color borderColor)
        {
            this.DrawLine(new Vector2(x, y), new Vector2(x + width, y), height, color);
